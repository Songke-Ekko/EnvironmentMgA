      ...
      <form action>
        <div class="layui-form">
          <div class="layui-form-item">
            <label class="layui-form-label add-label">草坪编号</label>
          ...
          <div class="layui-form-item">
            <label class="layui-form-label add-label">草的类别</label>
            <div class="layui-input-block">
              <select name="type" lay-verify="required" class="types">
                <option value></option>
                <option value="狗尾巴草">狗尾巴草</option>
                <option value="忘忧草">忘忧草</option>
                <option value="平车前">平车前</option>
                <option value="牛筋草">牛筋草</option>
              </select>
            </div>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label add-label">草坪面积</label>
            <div class="layui-input-block">
              <input
                type="text"
                name="acreage"
          ...
          <div class="layui-form-item">
            <label class="layui-form-label add-label">草坪周长</label>
            <div class="layui-input-block">
              <input
                type="text"
                name="perimeter"
          ...
          <div class="layui-form-item">
            <label class="layui-form-label add-label">草坪位置</label>
            <div class="layui-input-block">
              <input
                type="text"
                name="position"
          ...
          <div class="layui-form-item">
            <label class="layui-form-label add-label">栽培时间</label>
            <div class="layui-input-block">
              <input
                type="text"
                name="date"
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input
                ...
                lay-verify="required"
                placeholder="请输入草坪面积"
                class="layui-input edit-acreage"
                v-model="acreage"
                oninput="value=value.replace(/[^\d]/g,'')"
              >
            </div>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input
                ...
                placeholder="请输入草坪周长"
                autocomplete="off"
                class="layui-input edit-perimeter"
                v-model="perimeter"
                oninput="value=value.replace(/[^\d]/g,'')"
              >
            </div>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input
                ...
                lay-verify="required"
                placeholder="请输入草坪位置"
                class="layui-input edit-position"
                v-model="position"
              >
            </div>
          </div>
...
export default {
      ...
      table.render({
        ...
        cols: [
          [
            ...
            { field: "type", title: "草的类别", width: "15%", align: "center" },
            {
              field: "date",
              title: "栽培时间",
              width: "13.2%",
          ...
          case "update":
            if (localStorage.getItem("signIn") == "1") {
              if (data.length === 0) {
                ...
                form.render()
                that.acreage = checkStatus.data[0].acreage
                that.perimeter = checkStatus.data[0].perimeter
                that.position = checkStatus.data[0].position
  ...
  methods: {
    ...
    add() {
      let that = this;
      if ( that.number == "" || $(".types").val() == "" || that.acreage == "" || $(".dates").val() == "" || that.perimeter == "" || that.position == "" ) {
        layer.open({
          type: 1,
          title: false,
          anim: 4,
        ...
        .post(webUrl + "admin/addGlasses", {
          number: that.number,
          type: $(".types").val(),
          date: $(".dates").val(),
          acreage: that.acreage,
