      ...
      <form action>
        <div class="layui-form">
          <div class="layui-form-item">
            <label class="layui-form-label add-label">花丛编号</label>
          ...
          <div class="layui-form-item">
            <label class="layui-form-label add-label">花的类别</label>
            <div class="layui-input-block">
          ...
          <div class="layui-form-item">
            <label class="layui-form-label add-label">花丛面积</label>
            <div class="layui-input-block">
              <input
                type="text"
                name="acreage"
          ...
          <div class="layui-form-item">
            <label class="layui-form-label add-label">花丛周长</label>
            <div class="layui-input-block">
              <input
                type="text"
                name="perimeter"
          ...
          <div class="layui-form-item">
            <label class="layui-form-label add-label">花丛位置</label>
            <div class="layui-input-block">
              <input
                type="text"
                name="position"
      ...
      table.render({
        ...
        cols: [
          [
            ...
            { field: "type", title: "花的类别", width: "15%", align: "center" },
            {
              field: "date",
              title: "栽培时间",
              width: "13.2%",
