<template>
  <div>
    ...
    <div class="layui-col-md10 help-center-content">
      <div class="help-center-content-title">附近环境：</div>
      <div class="help-center-content-text">
        <p>如有任何咨询或建议，请联系我们：</p>
      </div>
      <div class="layui-row">
        <div class="layui-col-md10 help-center-content-middle">
          <div class="layui-col-md3 help-center-content-middle-child1">
            <div>
              <div class="help-center-content-middle-child1-icon"></div>
              <span id="zhengzhou">Zhengzhou University</span>
            </div>
            <span>地点：河南省郑州市郑州大学北校区</span>
            <span>联系电话：13938338016</span>
            <span>时间：星期一&nbsp;&nbsp;----&nbsp;&nbsp;星期日 10:00---22:00</span>
          </div>
          <div class="help-center-content-right"></div>
        </div>
      </div>
      <hr>
    </div>
...
.help-center-content-text p {
  font-weight: bold;
}
.help-center-content-middle {
  margin-top: 40px;
  display: flex;
}
.help-center-content-middle span {
  display: block;
  text-align: left;
  font-weight: bolder;
  width: 300px;
...
.help-center-content-middle-child1-icon {
  width: 21px;
  height: 22px;
...
.help-center-content-right {
  width: 700px;
  height: 300px;
  background-image: url(../../static/images/地图.png);
